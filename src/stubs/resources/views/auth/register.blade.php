    ...
    <div class="min-h-screen flex items-center">
        <div class="bg-white w-full max-w-lg rounded-lg shadow overflow-hidden mx-auto">
            <div class="py-4 px-6">
                ...
                <div class="mt-1 text-center text-gray-600">انشاء حساب جديد</div>
            ...
            <div class="flex items-center justify-center py-4 bg-gray-100 text-center">
                <h1 class="text-gray-600 text-sm">لديك حساب؟</h1>
                <a href="/login" class="text-blue-600 font-bold mx-2 text-sm hover:text-blue-500">قم بالدخول</a>
            </div>
        </div>
    </div>
@endsection
